...
export default function DashboardGlobal() {
  const mockData = [
    { name: "Jan", empresas: 12, faturamento: 45000 },
    { name: "Fev", empresas: 15, faturamento: 52000 },
    { name: "Mar", empresas: 18, faturamento: 61000 },
    { name: "Abr", empresas: 20, faturamento: 73000 },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">R$ 231.000</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Ticket Médio Global</CardTitle>
            <svg className="h-4 w-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Média entre todas as empresas</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Crescimento de Empresas e Faturamento</CardTitle>
